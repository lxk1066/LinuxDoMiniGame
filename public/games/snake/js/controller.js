...
export default class Controller {
  ...
  constructor(groundSize, gameOverCallback) {
    this.direction = " ";
    this.proceed = true;
  ...
  checkBoundary(snake, render, food) {
    ...
    if (
      ...
      this.stopGame();
      snake.buckleBlood();
      render.reRenderSnakeLifeVal(snake.getLifeVal());
  ...
  checkEatFood(snake, render, food) {
    const headEl = document.querySelector(`[data-v="${snake.headX}-${snake.headY}"]`);
